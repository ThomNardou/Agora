export default function EmailFooter(unsubscribeUrl: string, appUrl: string, nlId?: number) {
    return `
        ...
        <tr>
            <td style="padding:24px 48px;text-align:center;">
                <p style="margin:0;font-size:12px;color:#a1a1aa;">
                    ...
                    ${nlId ? `<img src="${appUrl}/api/newsletters/track/opened?t=${Buffer.from(`${nlId}`).toString("base64")}" alt="" width="1" height="1" style="display:none;border:0;" />` : ""}
                </p>
            </td>
        </tr>
